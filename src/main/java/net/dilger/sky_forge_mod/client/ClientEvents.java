...
import net.dilger.sky_forge_mod.gui.screen.skill_tree.SkillScreen;
    ...
    public static class ClientForgeEvents {
        ...
        public static void onKeyInput(InputEvent.Key event) {
            if(KeyBinding.keySkills.consumeClick()) {
                ...
                DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> Minecraft.getInstance().setScreen(new SkillScreen()));
