...
public class C2SIncreasePlayerSpeedPacket {
     ...
     */
    public C2SIncreasePlayerSpeedPacket(byte amount) {
        this.amount = amount;
    }

    public C2SIncreasePlayerSpeedPacket(FriendlyByteBuf buf) {
       this(buf.readByte());
    }
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            ...
            player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, MobEffectInstance.INFINITE_DURATION, totalAmplification));
