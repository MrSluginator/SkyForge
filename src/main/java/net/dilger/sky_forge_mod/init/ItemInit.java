...
import static net.dilger.sky_forge_mod.init.CreativeTabInit.addToTab;

//import static dev.turtywurty.tutorialmod.init.CreativeTabInit.addToTab;

public class ItemInit {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, SkyForgeMod.MOD_ID);
