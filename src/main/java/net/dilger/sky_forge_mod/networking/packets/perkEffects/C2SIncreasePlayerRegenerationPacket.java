...
public class C2SIncreasePlayerRegenerationPacket {
     ...
     */
    public C2SIncreasePlayerRegenerationPacket(byte amount) {
        this.amount = amount;
    }

    public C2SIncreasePlayerRegenerationPacket(FriendlyByteBuf buf) {
       this(buf.readByte());
    }
