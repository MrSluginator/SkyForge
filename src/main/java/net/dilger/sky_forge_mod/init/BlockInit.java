...
import net.dilger.sky_forge_mod.block.*;
...
public class BlockInit {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, SkyForgeMod.MOD_ID);
