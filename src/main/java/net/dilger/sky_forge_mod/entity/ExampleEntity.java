package net.dilger.sky_forge_mod.entity;

import net.dilger.sky_forge_mod.init.EntityInit;
import net.dilger.sky_forge_mod.init.ItemInit;
...
public class ExampleEntity extends Animal {
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob otherParent) {
        return new ExampleEntity(level, this.blockPosition());
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(9, new TemptGoal(this, 1.0D, Ingredient.of(ItemInit.EXAMPLE_ITEM.get()), false));
    }
