...
public class GainMiningXpC2SPacket {
    private static final String MESSAGE_GAIN_XP = "message.sky_forge_mod.gain_xp";
    private final PlayerSkillXp.SKILL_TYPE skill_type = PlayerSkillXp.SKILL_TYPE.MINING;

    public GainMiningXpC2SPacket() {
        System.out.println("empty"+this);
    }

    public GainMiningXpC2SPacket(FriendlyByteBuf buf) {
