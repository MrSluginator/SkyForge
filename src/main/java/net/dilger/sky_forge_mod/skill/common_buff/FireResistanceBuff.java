...
import net.dilger.sky_forge_mod.networking.packets.perkEffects.C2SIncreasePlayerFireResistancePacket;
import net.dilger.sky_forge_mod.skill.Buff;
import net.minecraft.advancements.critereon.DeserializationContext;
import net.minecraft.resources.ResourceLocation;

public class FireResistanceBuff implements Buff {
    static final ResourceLocation PACKET = new ResourceLocation(SkyForgeMod.MOD_ID, "fire_resistance");
    ...
    public void runPacket() {
        System.out.println("Run Packet Fire");
        PacketHandling.sentToServer(new C2SIncreasePlayerFireResistancePacket(amount));
    }
}
