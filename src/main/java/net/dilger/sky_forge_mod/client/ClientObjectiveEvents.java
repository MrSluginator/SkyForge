    ...
    public static class ClientForgeEvents {
        ...
        public static void offensiveObjectiveEvent(LivingDeathEvent event) {
            ...
            if (event.getSource().getEntity() instanceof Player player) {
                PacketHandling.sentToServer(new SendXPpacket(PlayerSkillXp.SKILL_TYPE.OFFENSE, (byte) 1));
            }
        }
...
//                ClientSkillXpData.addDefensive_xp((long) (event.getBlockedDamage() * 10));
                PacketHandling.sentToServer(new SendXPpacket(PlayerSkillXp.SKILL_TYPE.DEFENSE, (byte) 1));
            }
        }
