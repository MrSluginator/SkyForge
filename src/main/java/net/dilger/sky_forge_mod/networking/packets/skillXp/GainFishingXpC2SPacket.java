...
public class GainFishingXpC2SPacket {
    private static final String MESSAGE_GAIN_XP = "message.sky_forge_mod.gain_xp";
    private final PlayerSkillXp.SKILL_TYPE skill_type = PlayerSkillXp.SKILL_TYPE.FISHING;

    public GainFishingXpC2SPacket() {
        System.out.println("empty"+this);
    }

    public GainFishingXpC2SPacket(FriendlyByteBuf buf) {
